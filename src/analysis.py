...
promedios_matreias.plot(kind="bar")
plt.title("Promedio por matria")
plt.xlabel("Materia")
plt.ylabel("Promedio")
plt.xticks(rotation=0)
plt.tight_layout()
plt.savefig("outputs/resultados/grafica_materias.png")
plt.close()

prom_cruso.plot(kind="bar")
plt.title("Promedio segun el curso de preparacion")
plt.xlabel("Curso de preparacion")
plt.ylabel("Promedio")
plt.xticks(rotation=0)
plt.tight_layout()
plt.savefig("outputs/resultados/grafica_curso.png")
plt.close()

prom_padres.plot(kind="bar")
plt.title("Promedio segun el nivel educativo de los padres")
plt.xlabel("Nivel educativo de los padres")
plt.ylabel("Promedio")
plt.xticks(rotation=45, ha="right")
plt.tight_layout()
plt.savefig("outputs/resultados/grafica_padres.png")
plt.close()

plt.hist(datos["average_score"], bins=10)
plt.title("Distribucion del promedio")
plt.xlabel("Promedio")
plt.ylabel("Cantidad de estudiantes")
plt.tight_layout()
plt.savefig("outputs/resultados/grafica_histograma.png")
plt.close()

datos.to_csv("outputs/resultados/datos_limpios.csv", index=False)

print("")
print("Listo, revisa la carpeta outputs/resultados")
